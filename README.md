...
## v5 — Interactive Resume Rooms
- Replaced quiz-style checkpoints with point-and-click virtual rooms.
- Four rooms reveal education, skills, projects and journey artifacts.
- No quiz questions are required to progress: explore every glowing artifact.
- Narration pauses while a room is being explored and resumes after the room is completed.
- Game music is generated locally with Web Audio, so no copyrighted/external audio files are required.
- Progress is stored under the v5 localStorage key.
